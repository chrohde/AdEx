...
# ╔═╡ f5bd9ed6-eb35-41ae-ae60-9bd1ddf6437b
using Unitful: ms, upreferred, ustrip

# ╔═╡ 92f8ddd3-0be6-4c4f-b738-d6426eff20f8
# ╠═╡ show_logs = false
using CairoMakie: lines

# ╔═╡ a7428973-6c0d-4efc-8777-85f587dfd5b2
# ╠═╡ show_logs = false
using DifferentialEquations

# ╔═╡ 584f91aa-759b-11ee-197f-f93b8a618c51
include("src/AdEx_parms.jl");

# ╔═╡ e01a96eb-c594-4c54-b7d7-7139045ef72c
include("src/AdEx_model.jl");

# ╔═╡ a86e16f8-d451-45e3-98a1-85c3a2828380
include("src/AdEx_plot.jl");

# ╔═╡ b788ffe7-a14d-415c-9ee8-97858d7375dd
include("src/AdEx_utils.jl");

# ╔═╡ 1d247976-09e4-4a75-9de1-2259b5bd832b
sol = simulate(brette_2005, (0.0ms, 300.0ms), (50.0ms, 250.0ms), false);

# ╔═╡ 088b7e59-2e72-49c5-878e-a43042465dc8
plot_pattern(sol)

# ╔═╡ 583782d5-cf09-4e30-98cf-3436663288f8
spike_count(sol)
...
julia_version = "1.9.2"
manifest_format = "2.0"
project_hash = "887baba51e55186f157b005a6590849c593fb9e7"
...
git-tree-sha1 = "eac5b754896a56df0b9e049a3d93cc27912a78f2"
